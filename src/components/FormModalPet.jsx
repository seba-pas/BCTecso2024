...
const FormModalPet = ({ accion, datosPet }) => {
  ...
  const returnNavigateText = (accion) => (accion === "s" ? "/home_shelter" : "/success_submit_pet");
  ...
  return (
    <div className="text-center">
      ...
      <button className="w-100 btn background-button-muma btn-sm text-light rounded" onClick={() => navigate(returnNavigateText(accion))}>Continuar</button>
    </div>
  );
};
